...
function showeditemodal(id) {
    $.get("/Doctor/GetBy", { Id: id }, function (resulat) {
        ...
        var str = '<div class="modal-header p-3 mb-2 bg-primary text-white"> <h3>   EDIT MEDECIN </h3>    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" >&times;</span ></button ></div ><div class="modal-body">  <div class="form-row">' +
