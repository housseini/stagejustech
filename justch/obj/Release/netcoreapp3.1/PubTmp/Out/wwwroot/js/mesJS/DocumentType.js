...
function ModifierdOCUMENTYPE(daa) {
    ...
    $.get("/DocumentType/getByCode", { Code: daa }, function (t) {
        ...
        $("#inputmodifier").empty();
        $("#inputmodifier").append('<label for="inputPassword4" class="float-left">  Code <span>*</span></label><input type = "text" class="form-control" id = "Codemodifier" placeholder = "Code" value="' + t.Code + '" >')
        $("#inputmodifier1").empty();
        $("#inputmodifier1").append('<label for="inputPassword4" class="float-left">  Nom <span>*</span></label><input type = "text" class="form-control" id = "Nommodifier" placeholder = "Nom" value="' + t.Label + '" >')
