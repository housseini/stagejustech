...
function addMedicalAct() {
    class MedicalAct {
        ...
        constructor() {
            this.ID = 0;
            this.Name = $("#Name").val();
            this.MedicalActType = $("#MedicalActType").val();
...
function showeditemodal(id) {
    $.get("/MedicalAct/GetByid", { id: id }, function (resulat) {
        ...
        var str = ' <h3>   EDIT Medical </h3>  <div class="form-row">' +
            ...
            ' <input type="text" class="form-control" id="MedicalActType1" value="' + resulat.MedicalActType + '"> ' +
            '  </div>' +
            '  <div class="form-group col-md-6">' +
...
function Enregistrer(id) {
    ...
    class MedicalAct {
        ...
        constructor() {
            this.ID = id;
            this.Name = $("#Name1").val();
            this.MedicalActType = $("#MedicalActType1").val();
