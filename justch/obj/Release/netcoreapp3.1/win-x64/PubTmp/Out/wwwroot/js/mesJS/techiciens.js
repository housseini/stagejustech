...
function edited(Id) {
    ...
    $.get("/TechnienEnbrylogiste/GetById", { id: Id }, function (re) {
        var st = '<h3>   modifier technicien </h3>  <div class="form-row">  <div  class="form-group col-md-6">' +
            ...
            '  <div class="form-group col-md-6"> <label for="inputAddress2"   class="float-left" >LastName </label>   <input type="text" class="form-control" id="LastName1"  value="' + re.LastName + '">     </div>      </div>';
