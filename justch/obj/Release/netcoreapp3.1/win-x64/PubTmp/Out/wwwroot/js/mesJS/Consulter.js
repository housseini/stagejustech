    ...
    $.ajax({
        ...
        success: function (resulta) {
            ...
            if (resulta.length == 0) {
                ...
                var p
                if (resulta[1]['Photo'] == undefined ||resulta[1]['Photo'] == null) {
                    p = '  <img style="height: 150px; width:60%;"  class="rounded-circle" src="/img/user.jpg" />'
                }
                else {
...
function GetRdvBypatient(idpatient) {
    model =[]
    $.ajax({
        type: "get",
        ...
        success: function (resulta) {
            ...
            resulta.forEach(function (item) {
                ...
                rdv = {
                    ...
                    //(item['doctors'][0]['FirstName'])

            //    var str = '<div class="card-box">' +
            //        '<h3 class="card-title" > &nbsp; &nbsp;    &nbsp; &nbsp;' + item['patients'][0]['Civility'] + '</h3 >' +
            ...
            //        '<a href="#/" class="name"> ACT &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['medicicalActs'][0]['Name'] + '</a>' +
            //        '<span class="time">Jours   &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['Appointment']['Date'].split('T')[0] +'  </span>'+
            //        '<span class="time">Heur    &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['Appointment']['Hour1'].split('T')[1] +' </span>' +
            //        '<span class="time">salle     &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['rooms'][0]['Name'] +' </span>' +
            //        '<span class="time">Duré  &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['medicicalActs'][0]['Duration'] +' </span>' +
            //        '<span class="time">Docteur  &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['doctors'][0]['FirstName'] + ' &nbsp; &nbsp; &nbsp; &nbsp;' + item['doctors'][0]['LastName']  +' </span>' +
            //        '<div><a>Notes :  &nbsp; &nbsp; ' + item['Appointment']['Notes'] +'</a></div>' +
            //        '<div><a> state :  &nbsp; &nbsp; ' + item['Appointment']['State'] +' </a></div>' +
            //    '</div>     ' +
            //    '</div>' +
            //    '</li>' +
            //    '</ul>' +
            ...
            //        var str = '<div class="card-box">' +
            //            '<h3 class="card-title" > &nbsp; &nbsp;    &nbsp; &nbsp;' + item['patients'][1]['Civility'] + '</h3 >' +
            //            '<div class="experience-box">' +
            //            '<ul class="experience-list">' +
            //            '<li>' +
            //            '<div class="experience-user">' +
            ...
            //            '<a href="#/" class="name"> ACT &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['medicicalActs'][0]['Name'] + '</a>' +
            //            '<span class="time">Jours   &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['Appointment']['Date'].split('T')[0] + '  </span>' +
            //            '<span class="time">Heur    &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['Appointment']['Hour2'].split('T')[1] + ' </span>' +
            //            '<span class="time">salle     &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['rooms'][0]['Name'] + ' </span>' +
            //            '<span class="time">Duré  &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['medicicalActs'][0]['Duration'] + ' </span>' +
            //            '<span class="time">Docteur  &nbsp; &nbsp;   &nbsp; &nbsp; ' + item['doctors'][0]['FirstName'] + ' &nbsp; &nbsp; &nbsp; &nbsp;' + item['doctors'][0]['LastName'] + ' </span>' +
            //            '<div><a>Notes :  &nbsp; &nbsp; ' + item['Appointment']['Notes'] + '</a></div>' +
        ...
        "aoColumns":
            [
                ...
                { "data": "fichier", "name": "Nom du fichier", "autoWidth": true },
                {
                    ...
                    return '<a class="dropdown-item" href="/Documents/' + data + '"><i class="fa fa-pencil m-r-5"></i> Consulter </a>'
                    }
                }
                ,
                {
