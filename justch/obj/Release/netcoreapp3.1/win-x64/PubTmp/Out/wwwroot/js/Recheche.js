...
$(document).ready(function () {
    ...
    $('#table_id').dataTable({
        ...
        //                    + '<a class="dropdown-item" href="/Patient/Profile/' + data
        //                    + '"  onclick="addidtolocalstorage(' + data + ')"><i class="fa fa - plus m - r - 5"  ></i> consulter</a>'
        //                    + '<a class="dropdown-item" href="/Patient/EditPatient/'
        //                    + data + '"  onclick="edit(' + data + ')"><i class="fa fa - plus m - r - 5"  ></i> modifier</a>'
        //                    + '	<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_patient" onclick="addidtolocalstorage(' + data + ')"><i class="fa fa - trash - o m - r - 5"></i> Supprimer</a>'
        //                    + '</div>' + '</div >' + '</td >'
        //            }
        //        }
