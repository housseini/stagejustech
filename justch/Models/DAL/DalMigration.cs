        ...
        public static Message create_table_EnbryonTransfertData()
        {
            try
            {
                string query = "If not exists (select * from sysobjects where name = 'EnbryonTransfertData') CREATE TABLE [dbo].[EnbryonTransfertData] (" +
                    "[Id] BIGINT IDENTITY(1, 1) NOT NULL," +
                    "[IdActDataTransfertsEnbryonnaire] BIGINT  NOT NULL," +
                     "[Numeroenbryon]  BIGINT  NOT  NULL," +
                     "[Glaire]  NVARCHAR(MAX)  NOT  NULL," +
              ...
              public static Message create_table_DevenirEmbryon()
        {
            try
            {
                string query = "If not exists (select * from sysobjects where name = 'DevenirEmbryon') CREATE TABLE [dbo].[DevenirEmbryon] (" +
                    ...
                    "[IdActeDataCulture] BIGINT  NOT NULL ," +
        ...
        public static Message create_table_ActDataDecoronisationOvocyteData()
        {
            try
            {
                ...
                string query = "If not exists (select * from sysobjects where name = 'ActDataDecoronisationOvocyteData') CREATE TABLE [dbo].[ActDataDecoronisationOvocyteData] (" +
                    ...
                    "[IdActDataDecoronisation] BIGINT  NOT NULL ," +
                     "[DecoronisationOvocyteNumeroOvocyte] BIGINT  NOT NULL," +
                    "[DecoronisationOvocyteEtat]  NVARCHAR(MAX)," +
                     "[DecoronisationOvocyteCommantaire] NVARCHAR(MAX) " +
                    ");";
        ...
        public static Message create_table_ActDataCulture()
        {
            try
            {
                string query = "If not exists (select * from sysobjects where name = 'ActDataCulture') CREATE TABLE [dbo].[ActDataCulture] (" +
                    "[Id] BIGINT IDENTITY(1, 1) NOT NULL," +
                    "[IdMedicalRecordAct] BIGINT  NOT NULL UNIQUE," +
                    "[IdJ1EmbryologisteDoctor] BIGINT ," +
                    "[IdJ2EmbryologisteDoctor] BIGINT  ," +
                    "[IdJ3EmbryologisteDoctor] BIGINT  ," +
                    "[IdJ4EmbryologisteDoctor] BIGINT  ," +
                    "[IdJ5EmbryologisteDoctor] BIGINT  ," +
                    "[IdJ6EmbryologisteDoctor] BIGINT  ," +
                    "[IdJ1Incubateur] BIGINT  ," +
                    "[IdJ2Incubateur] BIGINT  ," +
                    "[IdJ3Incubateur] BIGINT  ," +
                    "[IdJ4Incubateur] BIGINT  ," +
                    "[IdJ5Incubateur] BIGINT  ," +
                    "[IdJ6Incubateur] BIGINT  ," +
                    "[J1Chambres]  NVARCHAR(MAX)  ," +
                    "[J2Chambres]  NVARCHAR(MAX)  ," +
                    "[J3Chambres]  NVARCHAR(MAX)  ," +
                    "[J4Chambres]  NVARCHAR(MAX)  ," +
                    "[J5Chambres]  NVARCHAR(MAX)  ," +
                    "[J6Chambres]  NVARCHAR(MAX)  ," +
                     "[J1EmbryologisteDoctorType]  NVARCHAR(MAX)  ," +
                     "[J2EmbryologisteDoctorType]  NVARCHAR(MAX)  ," +
                     "[J3EmbryologisteDoctorType]  NVARCHAR(MAX)  ," +
                     "[J4EmbryologisteDoctorType]  NVARCHAR(MAX)  ," +
                     "[J5EmbryologisteDoctorType]  NVARCHAR(MAX)  ," +
                     "[J6EmbryologisteDoctorType]  NVARCHAR(MAX)  ," +
                     "[J1Heure]  NVARCHAR(MAX)  ," +
                     "[J2Heure]  NVARCHAR(MAX)  ," +
                     "[J3Heure]  NVARCHAR(MAX)  ," +
                     "[J4Heure]  NVARCHAR(MAX)  ," +
                     "[J5Heure]  NVARCHAR(MAX)  ," +
                     "[J6Heure]  NVARCHAR(MAX)  ," +
                     "[J1Date]  NVARCHAR(MAX)  ," +
                     "[J2Date]  NVARCHAR(MAX)  ," +
                     "[J3Date]  NVARCHAR(MAX)  ," +
                     "[J4Date]  NVARCHAR(MAX)  ," +
